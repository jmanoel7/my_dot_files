...
let g:easytags_cmd = 'C:/wb64/bin/ctags.exe'
...
let g:UltiSnipsListSnippets="<leader><c-0>"
let g:UltiSnipsExpandTrigger="<leader><c-9>"
...
let g:notes_directories = ['~/Dropbox/servidor_ifg/notas']
...
let g:virtualenv_directory = '~/_local/venvs'
